...
const AudioPlayer = ({ audio: audioBlob }) => {
  ...
  useEffect(() => {
    ...
    testAudio.current.addEventListener("timeupdate", () => {
      ...
      if (durationSeconds > 0) {
        setProgress(
          (testAudio.current.currentTime / testAudio.current.duration) * 100
        );
      }
    });
  ...
  return (
    <Box>
      <Flex>
        ...
        <Text color={styles.body.primaryFill} alignSelf="center">
